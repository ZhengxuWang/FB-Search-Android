...
public class PagesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.activity_pages, container, false);
        ...
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                new PagesFragment.ReadJSON().execute("http://sample-env-1.fdxvbppf2e.us-west-2.elasticbeanstalk.com/h8.php?submit_search=" + keyword +"&type=page");
            }
        });
        return view;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        btnnext = (Button) getActivity().findViewById(R.id.nextPages);
        ...
        btnnext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    con = next;
                    arrayList = new ArrayList<>();
                    new PagesFragment.ReadJSON().execute(next);
        ...
        btnprev = (Button) getActivity().findViewById(R.id.prevPages);
        ...
        btnprev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    con = prev;
                    arrayList = new ArrayList<>();
                    new PagesFragment.ReadJSON().execute(prev);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
