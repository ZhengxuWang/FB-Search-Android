...
public class EventsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                new EventsFragment.ReadJSON().execute("http://sample-env-1.fdxvbppf2e.us-west-2.elasticbeanstalk" +
                        ".com/h8.php?submit_search=" + keyword +"&type=event");
            }
        });
        return view;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        btnnext = (Button) getActivity().findViewById(R.id.nextEvents);
        ...
        btnnext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    con = next;
                    arrayList = new ArrayList<>();
                    new EventsFragment.ReadJSON().execute(next);
        ...
        btnprev = (Button) getActivity().findViewById(R.id.prevEvents);
        ...
        btnprev.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    con = prev;
                    arrayList = new ArrayList<>();
                    new EventsFragment.ReadJSON().execute(prev);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
